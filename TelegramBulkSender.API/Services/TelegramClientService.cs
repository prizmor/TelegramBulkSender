...
public class TelegramClientService : IAsyncDisposable
{
    ...
    public TelegramClientService(IConfiguration configuration, TelegramSessionStorage sessionStorage, IMemoryCache memoryCache)
    {
